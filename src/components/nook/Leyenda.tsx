 ...
 */
function Forma({ tipo }: { tipo: 'cuadrado' | 'triangulo' | 'rombo' | 'anillo' | 'cruz' | 'circulo' }) {
  ...
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" aria-hidden="true" className="shrink-0">
      ...
      {tipo === 'circulo' && <circle cx="8" cy="8" r="5.1" fill={TINTA_MARCADOR} {...comun} />}
      {tipo === 'cruz' && (
        <path
      ...
      <div className="space-y-1.5">
        ...
        <ul className="space-y-1.5 pt-1">
          ...
          <li className="flex items-center gap-2">
            <Forma tipo="circulo" /> {ETIQUETAS.gestoria}
          </li>
          <li className="flex items-center gap-2.5 text-xs text-tinta-suave">
